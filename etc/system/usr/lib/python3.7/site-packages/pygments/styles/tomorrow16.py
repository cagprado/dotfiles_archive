...
BACKGROUND = "#ansilightgray"
CURRENT_LINE = "#ansiwhite"
SELECTION = "#ansidarkgray"
FOREGROUND = "#ansiblack"
COMMENT = "bold #ansilightgray"  # fix: pygments hardcode white as bold
RED = "#ansidarkred"
ORANGE = "#ansibrown"
YELLOW = "#ansiyellow"
GREEN = "#ansidarkgreen"
...
class Tomorrow16Style(Style):
    ...
    styles = {
        ...
        Generic.Prompt:            COMMENT,               # class: 'gp'
